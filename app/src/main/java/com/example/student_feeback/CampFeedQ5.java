...
public class CampFeedQ5 extends AppCompatActivity {
...
// id's that we have given in .XML file
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CampFeedQ5.this, campie.class);
    ...
    private void setData() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Campus Question5");
