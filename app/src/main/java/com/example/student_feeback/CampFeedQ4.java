...
public class CampFeedQ4 extends AppCompatActivity {
...
// id's that we have given in .XML file
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CampFeedQ4.this, CampFeedQ5.class);
    ...
    private void setData() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Campus Question4");
