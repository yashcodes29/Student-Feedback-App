...
public class CampFeedQ3 extends AppCompatActivity {
...
// id's that we have given in .XML file
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CampFeedQ3.this, CampFeedQ4.class);
    ...
    private void setData() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Campus Question3");
